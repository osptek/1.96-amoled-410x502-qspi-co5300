...
本仓库按料号分为多个分支。**仓库默认分支**为导航页 [`main`](https://github.com/osptek/1.96-amoled-410x502-qspi-co5300/tree/main)（不绑定单一料号）；完整产品资料在各料号分支。

| 型号 | 分支 | 说明 |
| ---- | ---- | ---- |
| — | [`main`](https://github.com/osptek/1.96-amoled-410x502-qspi-co5300/tree/main) | 多料号导航（仓库默认分支） |
| AM196Q410502LK | [`AM196Q410502LK`](https://github.com/osptek/1.96-amoled-410x502-qspi-co5300/tree/AM196Q410502LK) | **本分支** · 模组 |
...
规格标识（仓库名）：`1.96-amoled-410x502-qspi-co5300`
